...
import zhongshanLogo from "@/assets/zhongshan-logo-original-clean.png";
...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Zhongshan — selo agente oficial abaixo da marca ProAgro */}
      <div
        className="absolute top-28 left-8 hidden sm:flex"
        style={{
